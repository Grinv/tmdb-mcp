...
describe("jsonResult", () => {
  test("carries both text and structuredContent", () => {
...
describe("errorResult", () => {
  test("sets content and isError flag", () => {
...
describe("apiErrorToResult", () => {
  test("produces an actionable message per error code", () => {
